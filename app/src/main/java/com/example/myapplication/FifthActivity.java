    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(NARA.equals("southamerica") && Natural.equals("자연경관")) {
            ...
            second_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  칠레 아타카마 사막\n" +
                            "\n" +
                            "세상에서 가장 건조한 사막이 칠레의 아타카마 사막. 풀 한 포기 살 것 같지 않은 아타카마 사막에는 아이러니하게도 많은 호수가 있다. 대부분 지하수가 솟아 나와 생긴 호수인데, 우유니 사막처럼 수백만 년 전 바다였던 곳이 대륙붕 충돌로 인해 만들어진 사막이라 색다른 소금호수들을 만날 수 있다.\n" +
                            "\n" +
                            "☞  비니쿤카 무지개산\n" +
                            "\n" +
                            "페루의 가장 큰 매력 중 하나인 자연이 선사하는 아름다운 경관이다. 무지개 산 비니쿤카는 케추아어로 ‘일곱 색깔 산’을 뜻하며 마추픽추가 있는 해발 5000m의 산으로, 퇴적암의 침식작용이 만들어 낸 아름다운 무지개 빛깔을 자랑한다. 비니쿤카의 봉우리와 주변 계곡을 물들인 붉은색, 노란색, 라벤더색의 터키석 줄무늬가 만드는 경관이 감동을 선사한다.\n" +
                            "\n" +
                            "☞  아르헨티나 - 브라질 이구아수 폭포\n" +
                            "\n" +
                            "아르헨티나와 브라질의 경계에 있는 세계에서 가장 거대한 3대 폭포 중 하나다. 이구아수 강이 지류이며 반원형 모양으로 2700 m에 달한다. 275개의 폭포 중 12개 폭포가 동시에 떨어져 매우 큰 굉음을 낸다 하여 \"악마의 목구멍\"이라 불리는 폭포는 높이 80 m로 가장 높다.");
                }
            });
            ...
            second_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  페루 잉카 트레일\n" +
                            "\n" +
                            "세계의 위대한 짧은 트레킹 중 하나이자 세계 3대 트레킹 코스 중 하나로 꼽히는 잉카 트레일은 안개 낀 산과 숲, 아열대성 정글, 무엇보다 잉카인들이 닦아놓은 돌길과 터널 등을 한번에 즐길 수 있는 환상적인 트레킹 코스이다. 잉카 유적지를 보며 옛 잉카인들이 걸었던 그곳을 그대로 따라 걸어가며 대자연을 느껴보아라.\n" +
                            "\n" +
                            "☞  아르헨티나 아콩카구아 산\n" +
                            "\n" +
                            "남미 원주민 언어닌 케추아어로 ‘경외할 만한 산’, 그 외 ‘흰 파수꾼’, ‘바위 파수꾼’이라는 의미의 이름처럼 안데스 산맥을 묵묵히 지키고 있는 남미의 최고봉 아콩카구아 산. 황톳빛의 척박한 대지와 쉬지 않고 불어대는 바람, 정상부의 빙하와 만년설이 주는 웅장함은 이곳이 아니면 만날 수 없는 특별한 풍경이다.\n" +
                            "\n" +
                            "☞  에콰도르 침보라소\n" +
                            "\n" +
                            "에베레스트 산에 견주는 에콰도르에서 가장 높은 산인 침보라소는 안데스 산맥의 성층 화산이다. 높이 솟아있지만 비교적 완만한 경사를 갖춘 이곳은 온 세상을 하얗게 물들이는 구름바다와 눈부신 만년설, 안데스 산맥의 파노라마 전망 등 아름다운 자연경관으로 가득하다.");
                }
            });
            ...
            second_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  쿠바 하바나 바라데로 비치\n" +
                            "\n" +
                            "쿠바의 대표 휴양지로 카리브해에 속해 있는 해변이다. 새하얀 모래사장과 에메랄드빛의 깨끗한 바다를 만날 수 있어 릴렉싱하기 좋은 휴양지이다. 외국인 전용 해변으로 지정되어 있다는 점이 독특한데, 그만큼 숙박 시설 등 인프라가 잘 갖추어져 있다.\n" +
                            "\n" +
                            "☞  볼리비아 우유니 라구나 베르데\n" +
                            "\n" +
                            "녹색 호수라는 뜻의 라구나 베르데는 해발고도 4000m에 위치해 있다. 구리 침전물로 인해 초록빛을 띄는데 그 광경을 보기 위한 사람들이 많다. 우뚝 솟은 산과 그 아래 펼쳐진 옥빛 호수를 바라보며 자연의 경이로움을 느껴볼 수 있다. \n" +
                            "\n" +
                            "☞  베네수엘라 로스 로케 스\n" +
                            "\n" +
                            "실제로 350 개가 넘는 섬으로 구성되어 있으며, 어떤 섬을 선택하든 놀라울 정도로 멋진 해변과 풍부한 해양 생물로 가득한 얕고 열대성 바다를 볼 수 있다. 산호초는 카리브해에서 가장 아름다운 수중 동물 군과 식물 군의 고향이기도 하다. 스노쿨링, 다이버, 낚시 등 어드벤처를 즐기고 싶은 사람과 같은 물 애호가들의 거대한 놀이터라고 불린다.");
                }
            });
            ...
            second_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  니카라과\n" +
                            "\n" +
                            "사람들이 많이 찾고 있지 않은 숨겨진 여행지 니카라과 ! 니카라과의 본연 모습뿐만 아니라 유럽의 느낌을 간직하고 있는 식민지 도시와 그라나다, 세로 네그로 등 잘 보존된 자연의 완벽한 조화를 볼 수 있으며 서핑과 스쿠버다이빙 등을 즐길 수 있다. \n" +
                            "\n" +
                            "☞  볼리비아\n" +
                            "\n" +
                            "남미 여행지 1순위로 손꼽히는 우유니 사막이 있는 볼리비아는 환승과 긴 비행시간, 그리고 고가의 항공권 때문에 선뜻 여행을 떠나기엔 어려운 여행지일 수도 있다. 하지만 그렇다고 포기하기에 볼리비아는 라파스 등 아름다운 여행지가 많으며, 막상 현지에 도착하면 놀라울 정도로 저렴한 물가를 자랑한다.\n" +
                            "\n" +
                            "☞  아르헨티나\n" +
                            "\n" +
                            "탱고의 고장으로 유명한 아르헨티나. 남미의 파리로 불릴 만큼 문화, 예술적으로 볼거리가 풍부하다. 특히, 부에노스아이레스에는 투어가 있는 대통령 궁으로 유명한 카사 로사다, 부에노스아이레스의 상징과도 같은 마요 광장, 세계 3대 오페라 극장으로 손꼽히는 콜론 극장을 주로 배낭여행객의 발길을 이끌고 있다.");
                }
            });
        }
        ...
        if(NARA.equals("southamerica") && Game.equals("축제")) {
            ...
            third_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  브라질 리우데자네이루 식물원\n" +
                            "\n" +
                            "수 천종의 식물들이 서식하는 수목원이자 연구 시설로, 식물원에는 호수, 강, 숲과 정원 등 다양한 자연 환경이 조성되어 있다. 채널부리 투칸 등 이국적인 조류를 구경할 수 있으며, 나무늘보, 큰귀주머니쥐와 게를 먹는 너구리가 서식하고 있다. 또한 나무 장난감과 모래상자가 비치된 대형 놀이터가 있어 어린 아이들이 있는 가족 나들이에 좋다.\n" +
                            "\n" +
                            "☞  멕시코 칸쿤 셀하\n" +
                            "\n" +
                            "세계 최대의 자연 해수 테마파크이자 세계 최대의 자연 해양 수족관으로 특별한 체험과 함께 즐거운 시간을 만끽할 수 있는 곳이다. 스노쿨링, 튜브 투어, 돌고래 체험, 정글 투어 등 다양한 액티비를 즐길 수 있으며, 신혼여행지로도 유명하다. 아이와 동반한 가족여행자에게도 추천한다.\n" +
                            "\n" +
                            "☞  칠레 산티아고 국립 동물원\n" +
                            "\n" +
                            "대자연에 둘러쌓여 있으며 거대한 공원이 이 동물원을 감싸고 있어 나들이 장소로 아주 좋은 곳이다. 마다카스카르에서 사는 원숭이, 칠레 남부쪽에 많이 서식하고 있는 물개와 도마뱀 등 다양한 종류의 동물을 볼 수 있다.");
                }
            });
            ...
            third_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  브라질 베뚜 까헤루 월드\n" +
                            "\n" +
                            "브라질 최대 규모의 놀이공원인 이곳은 카우보이 출신의 배우 베뚜 까헤루가 디즈니랜드 같은 놀이공원을 짓겠다는 포부로 만들어낸 곳이다. 알록달록한 놀이기구와 건물, 화려한 공연이 방문객의 눈길을 사로잡는다. 장난감을 판매하는 Hot Wheel 자동차 곡예쇼와 마다가스카 뮤지컬, 아크로바틱 공연 BLum 등 다양하고 화려한 쇼가 가득하다.\n" +
                            "\n" +
                            "☞  칠레 산티아고 판타실란디아\n" +
                            "\n" +
                            "칠레 산티아고의 오히긴스 공원 모퉁이에 위치한 놀이공원으로 1978년에 개장한 역사가 있다. 탑 스핀, 스트림 폴, 부메랑 등 현대적인 놀이기구와 키즈들을 위한 로킨터그, 토잉앤보잉 등의 놀이기구도 있어 남녀노소 모두가 편하게 즐길 수 있는 곳이다.\n" +
                            "\n" +
                            "☞  브라질 비치 파크\n" +
                            "\n" +
                            "열대지역 리조트로 가까이에 위치한 해변을 품은 곳으로, 브라질의 열대 DNA와 열정적인 문화를 배경으로 하는 비치파크. 맛있는 해산물 레스토랑과 수려한 전망, 7개의 상징적인 프로슬라이드 워터 어트랙션이 준비되어 있다. 특히 14층 높이에서 시속 105km 속도로 내려오는 워터슬라이드가 있다고 소문났다.");
                }
            });
        ...
        if(NARA.equals("southamerica") && Culture.equals("전통")) {
            ...
            fourth_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  브라질 상파울루 앵부\n" +
                            "\n" +
                            "우리나라 인사동, 멕시코의 주말 마켓처럼 장인들이 민속공예품을 손수 제작해 팔거나 전시하는 민속마을인 앵부. 화려하고 유니크한 느낌의 장신구와 광석으로 만든 공예품이 주요 물건이다.\n" +
                            "\n" +
                            "☞  볼리비아 라파즈 에티세리아 시장\n" +
                            "\n" +
                            "일명 ‘마녀 시장’으로 실제로 시장에소 불을 피우며 주술 의식을 행하는 곳이다. 이곳은 원주민들이 부정을 막는 부적이나 병을 치료하기 위한 약초를 팔기 시작하면서 생겨났다고 한다. 피어오르는 하얀 연기와 머리 위로 매달린 박제 동물들을 보면서 묘한 느낌을 받을 수 있을 것이다. 볼리비아에서는 새끼 라마를 바닥에 묻으면 행운이 따른다는 속설이 있다고 한다.\n" +
                            "\n" +
                            "☞  에콰토르 오타발로\n" +
                            "\n" +
                            "세계 최대의 가축시장인 오타발로. 남미에서 볼리방 다음으로 인디오 비율이 높다는 에콰도르에서 전통 인디오들의 삶을 보고 싶다면 이 시장을 추천한다. 바로 옆에는 우리나라의 남대문 시장과 분위기가 비슷한 전통 시장도 있다. 로컬 푸드는 물론 인디오 분들이 직접 짠 가방과 옷가지를 볼 수 있다.");
                }
            });
            ...
            fourth_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  페루 마추픽추\n" +
                            "\n" +
                            "페루의 옛 잉카 제국 도시 유적으로, 험준한 고지대에 위치한 신비한 도시였으나 지금은 폐허가 되어 있다 '마추픽추'라는 말은 [케추아어](https://namu.wiki/w/%EC%BC%80%EC%B6%94%EC%95%84%EC%96%B4)로 '늙은 봉우리'라는 뜻으로 해발 약 2437m에 위치한 고산도시다. 산 아래에서는 어디에 있는지도 볼 수 없다고 해서 잃어버린 도시라는 이름으로도 불린다.\n" +
                            "\n" +
                            "☞  쿠바 헤밍웨이 박물관\n" +
                            "\n" +
                            "헤밍웨이를 좋아하는 분이시라면 꼭 가봐야 할 곳 중 1위. 헤밍웨이 박물관은 그가 당시 살던 집을 박물관으로 개조하여 관광명소로 변신한 곳이다. 하바나 시내에서 살짝 떨어진 곳에 위치하고 있지만 누구나 사랑하는 세계적 작품을 써낸 작가의 생가이기에 방문할 가치가 높다.\n" +
                            "\n" +
                            "☞  멕시코 칸쿤 치첸이사\n" +
                            "\n" +
                            "세계 7대 불가사의로 꼽히는 곳이자 7-13세기 후반의 유적지로 고대 마야 문명을 만날 수 있는 곳이다. 유네스코 세계 유산으로 지정되어 있는 치첸이사는 쿠쿨칸 피라미드, 구기장, 벽화 등 볼거리가 많아 이곳에만 들러도 멕시코의 많은 것을 보고 듣고 경험할 수 있다.");
                }
            });
            ...
            fourth_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  아르헨티나 산텔모 도레고 광장\n" +
                            "\n" +
                            "도레고 광장은 다양한 거리예술가들의 근사한 무대이자 공연장이다. 과거 고향을 잃은 이주민, 노예로 끌려온 흑인 등 소외된 사람들이 울분을 풀기 위해 술을 마시고 노래를 부르며 춤을 추었던 모습이 지금의 탱고를 탄생시킨 역사이다. 이와 관련된 화려하지만 한편으로 슬픈 내면을 담고 있는 공연을 이 도레고 광장 곳곳에서 볼 수 있을 것이다. \n" +
                            "\n" +
                            "☞  아르헨티나 부에노스 아이레스 엘 아테네오\n" +
                            "\n" +
                            "겉으로는 평범한 서점으로 보이지만 내부에서는 화려하고 웅장한 공연을 펼친 오페라하우스였던 엘 아테네오. 100년의 역사가 담긴 이 장소는 세상에서 가장 아름다운 도서관으로도 알려져 있다.  현재는 12만여권의 서고를 자랑하고 있으며 무대는 카페테리아로 변신하여 방문객을 맞이하고 있다.");
                }
            });
        }
        ...
        if(NARA.equals("southamerica") && Gita.equals("시장")) {
            ...
            fifth_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  페루 리마 센트럴 마켓\n" +
                            "\n" +
                            "대통령궁과 중앙 광장에 인접해있어 접근이 용이하다. 본관에는 신선한 과일과 다양한 채소를 구매할 수 있으며, 안쪽에서는 토끼, 기니피그 등 페루 전통음식에 사용되는 식재료를 손쉽게 구할 수 있답니다. 일반 상점보다 저렴한 가격으로 페루 전통음식을 즐길 수 있는 식당도 만나볼 수 있어, 페루 현지의 문화를 몸소 체험할 수 있다.\n" +
                            "\n" +
                            "☞  콜롬비아 보고타 빨로께마오 플라자\n" +
                            "\n" +
                            "보고타 내에서 가장 저렴하게 장을 볼 수 있는 재래시장으로 도매와 소매를 모두 책임지고 있는 곳이다. 그만큼 저렴하기 때문에 이른 아침부터 사람이 붐빈다. 이곳 가판대에서는 따말, 창구아 데 우베로 등 콜롬비아의 전통 대표 음식도 먹을 수 있다.\n" +
                            "\n" +
                            "☞  아르헨티나 부에노스아이레스 산뗄모\n" +
                            "\n" +
                            "아르헨티나의 재래시장으로 인테리어 소품, 생활용품, 악기 상점 등 잡화 매장과 식자재 시장이 있다. 시장을 걷다 보면 중간중간 사랑방 역할을 하는 아기자기한 소규모 카페도 볼 수 있을 것이다.");
                }
            });
        ...
        if(NARA.equals("os") && Natural.equals("자연경관")) {
            ...
            second_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  뉴질랜드 로토루아 와이토모 동굴\n" +
                            "\n" +
                            "유명한 반딧불이의 서식지로서 알려진 곳으로, 동굴 내부는 수많은 광장과 작은 방으로 나뉘며 천장은 종유석, 바닥에서는 석순이 늘어서 있다. 특히 보트로 미끄러지듯 이동하면서 머리 위에서 수천 마리의 반딧불이가 뿜어내는 빛의 장관을 감상할 수 있다.\n" +
                            "\n" +
                            "☞  호주 포트스테판\n" +
                            "\n" +
                            "많은 사람들이 방문해 모래 썰매를 즐겨 타는 곳으로 원래는 사막이 아니었지만 바닷바람에 날려온 모래가 쌓이기 시작해 거대해져 사막처럼 된 곳이다. 워리미 리저널 공원 내에 위치하며 사막 반대편에 해변이 있는 색다르고 특이한 풍경을 볼 수 있다. 모래가 많아 전자기기에 들어가면 고장날 수 도있으니 주의해야 한다.\n" +
                            "\n" +
                            "☞  호주 케언즈 쿠란다\n" +
                            "\n" +
                            "영화 아바타의 모티브가 된 열대우림, 초록색깔 그 자체인 야생 열대우림과 아기자기한 쿠란다 마을은 케언즈에서 절대 놓치면 안되는 명소이다. 여러 번 교통수단을 갈아 타고 찾아가야 하는 곳이기에 스카이레일, 쿠란다기차 티켓이 포함된 픽업 투어를 선택하는 것을 추천한다.");
                }
            });
            ...
            second_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  뉴질랜드 캔터베리 Conical Hill\n" +
                            "\n" +
                            "뉴질랜드 작은 마을 Hanmer springs의 Conical hill 주변에는 높은 건물이 없어 부담 없이 30분 만에 정상을 갈 수 있는 작은 산이지만 마을의 모든 전경을 볼 수 있다.\n" +
                            "\n" +
                            "☞  뉴질랜드 밀포드 트랙\n" +
                            "\n" +
                            "세계적으로 유명한 트랙 중 하나로, 세상에서 가장 아름다운 등산코스로 손꼽힌다. 100m 이상의 폭포, 투명한 호수, 동굴과 암벽 등이 이곳만의 운치있는 경관으로 아름다움을 자랑한다.\n" +
                            "\n" +
                            "☞  호주 유양스 국립공원\n" +
                            "\n" +
                            "반려견이 있으신 분들에게 추천드리는 등산코스이다. 해당 등산로는 반려견과 함께 등산할 수 있으며 정상 다 다르면 아름다운 전경이 맞이해주는 곳이다.\n" +
                            "\n" +
                            "☞  호주 웨리비 협곡\n" +
                            "\n" +
                            "웨리비 협곡은 가파른 절벽과 연못들이 있어 난이도가 높은 코스이기때문에 등산 마니아분들에게 추천드리는 등산 코스이다.");
                }
            });
            ...
            second_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  호주 케언즈 그레이트 배리어 리프\n" +
                            "\n" +
                            "세계 자연 유산으로 지정된 세계 최대의 산호초 지역으로 형형색색 바닷속이 장관을 이루고 있다. 크루즈를 타고 바다로 나가 스노쿨링, 스쿠버다이빙 등 액티비티를 즐기며 이 아름다운 바다를 온전히 느껴보길 바란다. 안전이 중요한 액티비티인 만큼 운영 업체 후기를 꼭 살펴보고 선택하는 것이 중요하다.\n" +
                            "\n" +
                            "☞  뉴질랜드 베이 오브 아일랜즈\n" +
                            "\n" +
                            "뉴질랜드 북섬의 144개의 섬으로 이루어진 이곳은 ‘섬들의 만’이라는 지명에서 알 수 있듯이 크루즈 명소이면서, 수백 대의 요트가 출항하는 항구다. 뉴질랜드에서 가장 인기 있는 해안 경주대회인 12마일 코스탈 클래식이 열려, 매년 많은 요트가 오클랜드에서 베이 오브 아일랜즈의 대표 도시 러셀에 운집한다. 한적한 백사장 해변이 주변에 있으며 해산물이 풍부해 미식 여행도 겸할 수 있다\n" +
                            "\n" +
                            "☞  호주 골드코스트 서퍼스 파라다이스\n" +
                            "\n" +
                            "골드코스트에서 가장 유명한 해변으로, 아름다운 해안선이 약 3km나 이어져있다. 이름처럼 서핑의 맛집이라고 불려 전 세계의 서퍼들을 부르고 있다. 그만큼 보드 대여소, 서핑 강습 프로그램이 잘 마련되어 있다.");
                }
            });
            ...
            second_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  호주 시드니\n" +
                            "\n" +
                            "배낭여행객들의 첫 시작을 담당하고 있는 도시인 시드니. 오페라 하우스, 하버 브릿지 등 호주의 랜드마크를 보며 가볍게 걸을 수 있으며 하버브릿지 클라이밍, 스카이다이빙 등의 액티비를 즐길 수 있다.\n" +
                            "\n" +
                            "☞  호주 울룰루\n" +
                            "\n" +
                            "대자연의 나라인 호주에서도 오지 중의 오지에 있는 이곳. 현지투어사의 도움이 있어야 순조로운 여행이 가능한 곳이다. 배낭여행객들에게는 특히 울룰루에서 즐길 수 있는 캠핑 투어를 강하게 추천하고 싶다.\n" +
                            "\n" +
                            " ☞  뉴질랜드 퀸스타운\n" +
                            "\n" +
                            "뉴질랜드에서 3번째로 큰 호수인 와카티푸의 주변 한 켠에 위치한 남섬의 도시로 레저를 즐기러 온 전세계의 여행객들의 거점으로 유명하다. 알프스 산맥, 밀포드 사운드 등 엄청난 자연이 자리잡고 있고, 이런 자연을 즐기고자 등반, 트레킹, 번지점프 등의 익스트림한 스포츠가 많이 발전되어 있다. 만약 일주일 무제한으로 시내버스를 이용할 수 있는 패스 카드도 판매하고 있으니, 쉼이 필요할 땐 버스도 편하게 이용할 수 있을 것이다.");
                }
            });
        }
        ...
        if(NARA.equals("os") && Game.equals("축제")) {
            ...
            third_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  뉴질랜드 스푸커스\n" +
                            "\n" +
                            "세트장과 야외에서 즐는 뉴질랜드의 유일한 공포 테마파크인 스푸커스. 시즌에 따라 3-5개 사이의 어트렉션이 있지만 그 중 haunted house와 cornevil이 재미있다고 소문났다. 공포와 스릴러물을 좋아하는 사람들은 무시무시한 퀄리티를 자랑하는 이곳을 꼭 방문해보길 바란다.\n" +
                            "\n" +
                            "☞  호주 시라이프 시드니 수족관\n" +
                            "\n" +
                            "세계 최대 규모의 호주 수중 생물이 모여 있으며, 14가지 테마의 여행을 떠날 수 있다. 해양 터널 워크, 유리 바닥 보트 투어를 포함한 비하인드 더 신 투어 등 다양한 투어가 준비되어 있다. 특히 샤크 리프 스노클 투어는 투명한 상자 안에 들어간 상태로 물속에 잠겨 상어와 함께 스노클링을 할 수 있다.\n" +
                            "\n" +
                            "☞  호주 시드니 페더데일 동물원\n" +
                            "\n" +
                            "1972년 농장을 개관한 곳으로 조류, 파충류, 포유류 등 250종의 1,700여 마리 야생동물이 있는 세계 최대 규모의 호주 동물 수집원이면서, 여러 사람들이 동물들과 교감을 나눌 수 있도록 하는 동물원이다. 또한, 이곳은 야생 동물을 보존하는 데에도 힘쓰고 있으며 동물을 통한 교육과 치료도 도모하고 있다.");
                }
            });
            ...
            third_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  호주 골드코스트 드림월드\n" +
                            "\n" +
                            "30만m2에 이르는 광대한 부지에 빽빽하게 들어선 시설이 아이들의 눈을 사로잡고 어른도 동심의 세계로 돌아가 신나는 시간을 보낼 수 있다. 벵갈호랑이와 코알라 인형이 컨트리송을 부르는 공연과 금 채광이 한창이던 개척시대의 거리를 재현한 골드 러시 컨트리에서 과거를 느껴 볼 수 있다. 자이언트 드롭 등 스릴 넘치는 놀이기구도 즐길 수 있다.\n" +
                            "\n" +
                            "☞  호주 위너 브라더스 무비월드\n" +
                            "\n" +
                            "헐리우드 영화가 살아있어 어른, 아이 할 것 없이 즐길 수 있는 테마파크로 세계적으로 유명하다. 무비월드에서 할리우드 액션 영화의 화려한 제작 과정과 스릴 넘치는 액션이 바로 눈앞에서 펼쳐지는 무비드는 영화 스튜디오를 재현한 스트리트가 있어 재미있는 추억을 만들 수 있을 것이다. 엄청난 속도의 슈퍼맨 탈출 놀이기구의 짜릿함도 즐겨보길 바란다.\n" +
                            "\n" +
                            "☞  뉴질랜드 레인보우 엔드\n" +
                            "\n" +
                            "오클랜드에 유일무이한, 뉴질랜드 통틀어 가장 큰 규모를 가진 레인보우 엔드. 소규모지만 fear fall, stratosfear, log flume 등 스릴 있는 놀이기구도 있으며 아이들이 즐기기 좋은 놀이기구도 있다.");
                }
            });
        ...
        if(NARA.equals("os") && Culture.equals("전통")) {
            ...
            fourth_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  파푸아뉴기니 Gapa-Neluwan Cultural Tourism\n" +
                            "\n" +
                            "파푸아뉴기니 원주민인 넬우안족의 전통과 문화를 경험할 수 있는 곳이다. 이곳은 원주민들의 삶의 방식, 집 건축물, 춤, 음악, 의례, 그리고 음식 등 다양한 측면에서 그들의 전통을 매우 잘 보존하고 있어 그들의 문화를 직접 체험할 수 있다.\n" +
                            "\n" +
                            "☞  뉴질랜드 로토루아\n" +
                            "\n" +
                            "뉴질랜드 북섬에 있는 도시로, 미타이 마오리 빌리지에서 마오리 원주민들을 만나고 전통 마오리 공연을 관람할 수 있다. 또한 스카이다이빙, 래프팅, 번지점프의 일종인 스웁 등 다양한 야외 활동을 체험할 수 있다. \n" +
                            "\n" +
                            "☞  호주 퀸즐랜드\n" +
                            "\n" +
                            "이곳은 세계에서 가장 오래된 역사 중 하나인 호주 원주민 문화를 외국인 관광객에 소개하는 데 힘쓰고 있으며, 최근 문화 체험 수요가 증가하고 있는 트렌드에 맞춰  다양한 투어를 선보이고 있어, 호주 문화와 토착 문화를 한꺼번에 만날 수 있는 곳이다. 원주민과 토레스 해협 섬의 거주민은 춤, 예술, 전통축제 등 자신의 문화를 타인과 나눔으로써 문화를 보존하고 있다.");
                }
            });
            ...
            fourth_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  뉴질랜드 타라나키 타휘티 박물관\n" +
                            "\n" +
                            "이 박물관은 타라나키의 역동적인 관광 리스트에 올리기에 손색이 없는 체험을 제공하는 공간이다. 뉴질랜드, 그리고 타라나키의 역사에 대한 다양한 장면을 아티스트 나이젤 오글이 박물관 내의 스튜디오에서 섬세한 손길로 고증, 재현해 제작한 디오라마와 피규어 작품 수천 점을 전시해 두고 있다.\n" +
                            "\n" +
                            "☞  호주 프리맨틀 감옥\n" +
                            "\n" +
                            "프레맨틀 감옥은 1850년대에 세워져 호주의 식민 시대 동안 영국과 아일랜드에서 온 죄수들을 받아들인 곳이다. 오늘날 이 역사적인 건물은 세계문화유산으로 지정되어 전 세계적으로 인정받는 곳으로 보존되고 있다. 이전 감옥이었던 이곳은 죄수들의 예술 작품을 전시하며 흥미롭고 다양한 볼거리를 제공하는 곳으로 변신했다.\n" +
                            "\n" +
                            "☞  타즈매니아 포트 아서 역사 유적지\n" +
                            "\n" +
                            "포트아서는 세상에서 가장 아름다운 교도소, 절대 탈출이 불가능한 교도소로 유명한 곳이다.이곳은 영국인 범죄자중 중범죄자들을 수감해 강제로 노역을 시킨 역사적인 문화 유적지로 1966년 대량학살 사건 현장이며, 2010년에는 유네스코 세계문화 유산으로 등록되었다.");
                }
            });
            ...
            fourth_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  호주 멜버른 내셔널 갤러리 오브 빅토리아\n" +
                            "\n" +
                            "1861년부터 각종 예술 작품을 전시한 호주에서 가장 오래되고 규모가 큰 미술관이다. 6만 3000점 이상의 세계 각국의 다양한 예술작품을 전시하고 있으며, 섬유, 패션, 인테리어 등 작품의 장르가 다양한 곳이다. 고대미술부터 다양한 현대미술을 담고 있으며 피카소, 모네, 세잔, 로댕, 무어 등 해외 유명 작가들의 작품도 전시되어 있다.\n" +
                            "\n" +
                            "☞  호주 시드니 오페라하우스\n" +
                            "\n" +
                            "1547석의 오페라 극장과 2679석의 음악당을 비롯해 여러 개의 극장, 전시관, 도서관 등이 있는 호주의 대표 예술의 전당인 이곳 오페라하우스. 이곳은 가장 유명하고 인상적인 20세기의 건축물 가운데 하나로, 세계에서 가장 유명한 공연장 중 하나 이다. 또한 2007년 유네스코 세계유산에 선정되었다.\n" +
                            "\n" +
                            "☞  뉴질랜드 웰링턴\n" +
                            "\n" +
                            "웰링턴의 문화의 거리라고 할 수 있는 쿠바스트릿에서 가장 자유분방한 분위기를 지닌 지역이다. 2년마다 쿠바 스트릿 카니발이 열리고 어느 곳을 지정하는 의미가 무색하게 거의 매일 거리의 악사, 전시공간, 돌조각 등이 있어 창조성과 예술의 중심지역으로 알려진 곳이다.");
                }
            });
        }
        ...
        if(NARA.equals("os") && Gita.equals("시장")) {
            ...
            fifth_button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    textView.setText("☞  호주 시드니 록스 마켓\n" +
                            "\n" +
                            "시드니 4대 마켓 중 하나로 관광객을 위한 물건들이 많이 판매되는 곳으로, 과거와 현재가 함께 공존하는 유럽피언 스타일의 마켓이자 시드니의 유구한 전통을 지닌 곳이기도 하다. 코알라, 캥거루와 관련된 상품도 많고 수공예나 핸드메이드 제품들도 판매하고 있다.\n" +
                            "\n" +
                            "☞  뉴질랜드 오클랜드 피시마켓\n" +
                            "\n" +
                            "오클랜드 최대의 어시장으로, 짜임새 있는 매장 구성과 요리교실, 공연장, 강연장, 놀이터 등 다양한 부대시설이 위치해 있다. 이곳에는 큰 배 모양의 스틸로 만들어진 대형 매대에 각종 생선들이 곧 살아서 튀어나올 듯이 진열돼 있다. 튀기거나 굽거나 훈제한 각종 생선들을 현장에서 바로 구입해서 먹을 수 있도록 부위별로 포장되어 있다.\n" +
                            "\n" +
                            "☞  호주 멜버른 퀸 빅토리아 마켓\n" +
                            "\n" +
                            "1878년 개장한 오랜 역사의 재래시장으로, 신선한 식재료는 물론, 다양한 수공예품과 모카신 등의 가죽 잡화, 액세서리 등을 매우 저렴한 가격으로 구입할 수 있다. 시장 맞은편에는 국내 여행 프로그램에 소개된 도넛 맛집, '아메리칸 도넛 키친'이 자리하고 있으니 시장을 둘러보기 전후로 방문하는 것을 추천한다.");
                }
            });
